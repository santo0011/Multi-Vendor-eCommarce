...
const Card = () => {
    ...
    return (
        <div>
            ...
            <section className='bg-[url("http://localhost:5000/images/banner/card.jpg")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
                                                    ...
                                                    p.products.map((pt, i) => <div className='w-full flex flex-wrap'>
                                                        ...
                                                        <div className='flex justify-between w-5/12 sm:w-full sm:mt-3'>
                                                            <div className='pl-4 sm:pl-0'>
                                                                ...
                                                                <h2 className='text-lg text-orange-500'>${(pt.productInfo.price - Math.floor((pt.productInfo.price * pt.productInfo.discount) / 100)) * pt.quantity} </h2>
                                                                <p className='line-through'>{(pt.productInfo.price) * pt.quantity}</p>
                                                            ...
                                                            <div className='flex gap-2 flex-col'>
                                                                ...
                                                                <button onClick={() => handleCardDelete(pt._id)} className='px-5 py-[3px] bg-red-500 text-white'>Delete</button>
                                                            </div>
                                                        </div>
                                                    </div>)
                                                }
                                                ...
                                                <div className='bg-white p-4'>
                                                    {
                                                        outofstock_products.map((p, i) => <div key={i} className='w-full flex flex-wrap'>
                                                            ...
                                                            <div className='flex justify-between w-5/12 sm:w-full sm:mt-3'>
                                                                <div className='pl-4 sm:pl-0'>
                                                                    <h2 className='text-lg text-orange-500'>${(p.products[0].price - Math.floor((p.products[0].price * p.products[0].discount) / 100)) * p.quantity} </h2>
                                                                    <p className='line-through'>{(p.products[0].price) * p.quantity}</p>
                                                                ...
                                                                <div className='flex gap-2 flex-col'>
                                                                    ...
                                                                    <button onClick={() => handleCardDelete(p._id)} className='px-5 py-[3px] bg-red-500 text-white'>Delete</button>
                                                                </div>
                                                            </div>
                                                        </div>)
                                                    }
