...
const load = async () => {
    return await loadStripe('pk_test_51NolxnKPP1hRVgwQoaYl9sDnFMWxS9hdjklaheiRZF60e0QTD8jMPCLeBIf2vtwjNAvFS58N8UTr31c2oqroAMVo00oT2yyqxY')
}
...
const ConfirmOrder = () => {
    ...
    const update_payment = async () => {
        ...
        if (orderId) {
            try {
                await api.get(`/home/order/confirm/${orderId}`);
