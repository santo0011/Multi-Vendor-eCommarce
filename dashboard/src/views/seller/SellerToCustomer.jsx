                                    ...
                                    return <>
                                        <Link to={`/seller/dashboard/chat-customer/${c.fdId}`} key={i} className={`h-[60px] flex justify-start gap-2 items-center text-white px-2 py-2 rounded-sm cursor-pointer ${customerId === c.fdId ? 'bg-slate-700' : ''}`}>
                                            <div className='relative'>
                                                <img className='w-[38px] h-[38px] border-white border-2 max-w-[38px] p-[2px] rounded-full' src={`${base_url}/images/admin.jpg`} alt="" />
                                                {
                        ...
                        <div className='flex justify-between items-center'>
                            {
                                customerId && <div className='flex justify-start items-center gap-3'>
                                    <div className='relative'>
                                        <img className='w-[42px] h-[42px] border-green-500 border-2 max-w-[42px] p-[2px] rounded-full' src={`${base_url}/images/admin.jpg`} alt="" />
                                        {
                                            ...
                                            return (
                                                <div key={i} ref={scrollRef} className='w-full flex justify-start items-center'>
                                                    <div className='flex justify-start items-start gap-2 md:px-3 py-2 max-w-full lg:max-w-[85%]'>
                                                        <div>
                                                            <img className='w-[38px] h-[38px] border-2 border-white rounded-full max-w-[38px] p-[3px]' src={`${base_url}/images/admin.jpg`} alt="" />
                                                        </div>
